checkoutBtn.addEventListener("click", async function () {
  ...
  try {
    ...
    if (!createPaymentResponse || !createPaymentResponse.paymentId || !createPaymentResponse.email) {
      ...
      callback: function (response) {
        ...
        fetch(`/update-payment-status/${createdPaymentId}`, {
          ...
          .then((updateRes) => {
            ...
            if (!updateRes.ok) {
              throw new Error(`Failed to update payment: ${updateRes.status} ${updateRes.statusText}`);
            }
